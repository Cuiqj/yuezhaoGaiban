...
- (NSDictionary *)xmlParser:(NSString *)webString{
    ...
    TBXMLElement *rr1 = [TBXML childElementNamed:@"DownloadDataSetResult" parentElement:r1];
    TBXMLElement *rrr1 = [TBXML childElementNamed:@"DownloadDataSetResult" parentElement:rr1];
    ...
    */
    ...
    TBXMLElement *rff=[TBXML childElementNamed:@"soap:Body" parentElement:root];
    if (!rff) {
        return userinfo;
    }
    TBXMLElement *r1 = [TBXML childElementNamed:@"DownloadDataSetResponse" parentElement:rff];
    if(!r1){
        return userinfo;
    }
...
- (NSDictionary *)xmlParser:(NSString *)webString{
    ...
    TBXMLElement *author=[TBXML childElementNamed:@"Table" parentElement:r2];
    //    TBXMLElement *author=r2->firstChild;
    //递归读Icon表中的Items内容
    while (author) {
        TBXMLElement *items=[TBXML childElementNamed:@"items" parentElement:author];
        @autoreleasepool {
