...
#import "XKAdBaseInfoController.h"
#import "XKSPInfoController.h"
#import "XKAttechmentController.h"


@implementation XKAdBaseInfoController
@synthesize txtAppno;
...
- (void)viewDidLoad
{
    ...
    [service getPermitAdvInfo:_appno];
...
-(void)getWebServiceReturnString:(NSString *)webString forWebService:(NSString *)serviceName{
    void(^XMLParser)(void)=^(void){
        ...
        TBXMLElement *r1=[TBXML childElementNamed:@"getPermitInfo_advResponse" parentElement:rf];
        TBXMLElement *r2=[TBXML childElementNamed:@"out" parentElement:r1];
        TBXMLElement *author=[TBXML childElementNamed:@"ns1:AdvertisingAppModel" parentElement:r2];
        NSString *value;
        ...
        value=[NSString stringWithFormat:@"共计%@年%@月%@日",[TBXML getXmlValue:@"term_y" inElement:author]
        ...
        [_data addObject:@"规划位信息"];
        [_detaildata addObject:@"暂空，待实现" ];
        [_data addObject:@"规划位编号"];
        [_detaildata addObject:[TBXML getXmlValue:@"planning_no" inElement:author] ];
        
        [_data addObject:@"支撑型式"];
        [_detaildata addObject:[TBXML getXmlValue:@"support_type" inElement:author] ];
        [_data addObject:@"设计总高度（M）"];
        [_detaildata addObject:[TBXML getXmlValue:@"high" inElement:author] ];
        [_data addObject:@"牌面数量"];
        [_detaildata addObject:[TBXML getXmlValue:@"sign_numbers" inElement:author] ];
        [_data addObject:@"牌面尺寸（长X宽）"];
        [_detaildata addObject:[TBXML getXmlValue:@"sign_size" inElement:author] ];
        [_data addObject:@"广告内容"];
        [_detaildata addObject:[TBXML getXmlValue:@"content" inElement:author] ];
        [_data addObject:@"属性"];
        [_detaildata addObject:[TBXML getXmlValue:@"attribute" inElement:author] ];
